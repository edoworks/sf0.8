...
- A newly discovered model is not approved merely because it is newer or cheaper. Routine and standard routes require passing benchmark evidence; complex, vision, and trust-boundary promotions also require operator approval.
